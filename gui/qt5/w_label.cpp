...
class Qt5_W_Label: public Qt5_W_Widget {
public:
  Qt5_W_Label(GWEN_WIDGET *w):Qt5_W_Widget(w) {
  }
  ...
  int setCharProperty(GWEN_DIALOG_PROPERTY prop,
    ...
    qw=(QLabel*) GWEN_Widget_GetImplData(_widget, QT5_DIALOG_WIDGET_REAL);
    assert(qw);
