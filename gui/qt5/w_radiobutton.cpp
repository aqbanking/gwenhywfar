...
class Qt5_W_RadioButton: public Qt5_W_Widget {
public:
  Qt5_W_RadioButton(GWEN_WIDGET *w):Qt5_W_Widget(w) {
  }
  ...
  int setIntProperty(GWEN_DIALOG_PROPERTY prop,
    ...
    qw=(QRadioButton*) GWEN_Widget_GetImplData(_widget, QT5_DIALOG_WIDGET_REAL);
    assert(qw);
