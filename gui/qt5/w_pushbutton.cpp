...
class Qt5_W_PushButton: public Qt5_W_Widget {
public:
  Qt5_W_PushButton(GWEN_WIDGET *w):Qt5_W_Widget(w) {
  }
  ...
  int setCharProperty(GWEN_DIALOG_PROPERTY prop,
    ...
    qw=(QPushButton*) GWEN_Widget_GetImplData(_widget, QT5_DIALOG_WIDGET_REAL);
    assert(qw);
