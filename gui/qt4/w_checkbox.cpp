...
class Qt4_W_CheckBox: public Qt4_W_Widget {
public:
  Qt4_W_CheckBox(GWEN_WIDGET *w):Qt4_W_Widget(w) {
  }
  ...
  int setIntProperty(GWEN_DIALOG_PROPERTY prop,
    ...
    qw=(QCheckBox*) GWEN_Widget_GetImplData(_widget, QT4_DIALOG_WIDGET_REAL);
    assert(qw);
