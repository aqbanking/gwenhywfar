...
typedef int (*GWEN_MSG_ENDPOINT_STARTMSG_FN)(GWEN_MSG_ENDPOINT *ep);
typedef int (*GWEN_MSG_ENDPOINT_ENDMSG_FN)(GWEN_MSG_ENDPOINT *ep);
typedef int (*GWEN_MSG_ENDPOINT_CHECKMSG_FN)(GWEN_MSG_ENDPOINT *ep);
...
GWENHYWFAR_API int GWEN_MsgEndpoint_StartMsg(GWEN_MSG_ENDPOINT *ep);
GWENHYWFAR_API int GWEN_MsgEndpoint_EndMsg(GWEN_MSG_ENDPOINT *ep);
GWENHYWFAR_API int GWEN_MsgEndpoint_CheckMsg(GWEN_MSG_ENDPOINT *ep);
...
GWENHYWFAR_API GWEN_MSG_ENDPOINT_STARTMSG_FN GWEN_MsgEndpoint_SetStartMsgFn(GWEN_MSG_ENDPOINT *ep, GWEN_MSG_ENDPOINT_STARTMSG_FN f);
GWENHYWFAR_API GWEN_MSG_ENDPOINT_ENDMSG_FN GWEN_MsgEndpoint_SetEndMsgFn(GWEN_MSG_ENDPOINT *ep, GWEN_MSG_ENDPOINT_ENDMSG_FN f);
GWENHYWFAR_API GWEN_MSG_ENDPOINT_CHECKMSG_FN GWEN_MsgEndpoint_SetCheckMsgFn(GWEN_MSG_ENDPOINT *ep, GWEN_MSG_ENDPOINT_CHECKMSG_FN f);
