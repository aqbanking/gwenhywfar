...
#define GWEN_IPCCONNLAYERCMD_SECSTATE_GREETED           4

#define GWEN_IPCCONNLAYERCMD_SECSTATE_EXCHANGING_PK     5
#define GWEN_IPCCONNLAYERCMD_SECSTATE_EXCHANGED_PK      6

#define GWEN_IPCCONNLAYERCMD_SECSTATE_EXCHANGING_SK     7
#define GWEN_IPCCONNLAYERCMD_SECSTATE_EXCHANGED_SK      8

#define GWEN_IPCCONNLAYERCMD_SECSTATE_ESTABLISHED       9
#define GWEN_IPCCONNLAYERCMD_SECSTATE_CLOSING           10
