...
#define GWEN_IPCCONNLAYERCMD_SECSTATE_PUBLIC_KEY_EXCHG  3
#define GWEN_IPCCONNLAYERCMD_SECSTATE_SESSION_KEY_EXCHG 4
#define GWEN_IPCCONNLAYERCMD_SECSTATE_ESTABLISHED       5
#define GWEN_IPCCONNLAYERCMD_SECSTATE_CLOSING           6
