...
const uint8_t* GWEN_Crypt_Token_KeyInfo_GetModulusData(const GWEN_CRYPT_TOKEN_KEYINFO *st) { assert(st); if (st->modulus) return (const uint8_t*) GWEN_Buffer_GetStart(st->modulus); else return NULL; }
...
const uint8_t* GWEN_Crypt_Token_KeyInfo_GetExponentData(const GWEN_CRYPT_TOKEN_KEYINFO *st) { assert(st); if (st->exponent) return (const uint8_t*) GWEN_Buffer_GetStart(st->exponent); else return NULL; }
...
const uint8_t* GWEN_Crypt_Token_KeyInfo_GetCertificateData(const GWEN_CRYPT_TOKEN_KEYINFO *st) { assert(st); if (st->certificate) return (const uint8_t*) GWEN_Buffer_GetStart(st->certificate); else return NULL; }
